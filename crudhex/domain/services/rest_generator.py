...
from crudhex.domain.services.rest import controller_generator, model_generator


def create_controller_class(entity: Entity, override: bool = False, folder: Optional[Path] = None) -> Tuple[bool, Path]:
